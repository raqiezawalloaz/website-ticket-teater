...
@section('header_title', 'Tambah Tenant')
@section('header_subtitle', 'Tambahkan data tenant baru ke dalam sistem')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 bg-gray-50/50">
            <h3 class="text-lg font-semibold text-gray-900">Formulir Tenant Baru</h3>
            <p class="text-sm text-gray-500 mt-1">Isi informasi detail mengenai tenant baru.</p>
        </div>
        ...
        <form action="{{ route('admin.tenants.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-100 mt-6">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Simpan Tenant
                </button>
            </div>
        </form>
    </div>
