...
<style>
    ...
    .event-banner {
        height: 250px; background: linear-gradient(135deg, #6366f1 0%, #a855f7 100%);
    ...
    <div class="main-column">
        <div class="event-card">
            <div class="event-banner">
                ...
                <h1 style="font-size: 2.2rem; font-weight: 800;">{{ $event->nama_event }}</h1>
            </div>
            <div class="event-body">
                <div class="section-title">Informasi Acara</div>
                <div class="meta-item">
                    <i class="fas fa-calendar-alt"></i>
                    <span>{{ $event->tanggal_event->format('d F Y') }} • {{ $event->tanggal_event->format('H:i') }} WIB</span>
                </div>
                <div class="meta-item">
